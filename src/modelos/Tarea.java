...
public class Tarea {
    ...
    public Tarea(Integer id_tarea, String titulo, String descripcion, Integer nivel_de_prioridad,String precio) {
   ...
   @Override
    public String toString() {
        return "Tarea{" + "id_tarea=" + id_tarea + ", titulo=" + titulo + ", descripcion=" + descripcion + ", nivel_de_prioridad=" + nivel_de_prioridad + ", precio =" + precio+'}';
    }
